...
uint32_t GetSector(uint32_t Address);//change Sector to address
void STMF429FLASH_WriteHalfWord(uint32_t WriteAddr,uint16_t *pBuffer,uint16_t NumToWrite);
void STMF429FLASH_ReadHalfWord(uint32_t ReadAddr,uint16_t *pBuffer,uint16_t NumToRead); //从指定地址开始读出指定长度的数据
void STMF429FLASH_WriteWord(uint32_t WriteAddr,uint32_t *pBuffer,uint16_t NumToWrite);
void STMF429FLASH_ReadWord(uint32_t ReadAddr,uint32_t *pBuffer,uint16_t NumToRead); //从指定地址开始读出指定长度的数据
#endif
